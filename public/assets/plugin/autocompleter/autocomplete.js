    ...
    job.prototype.pullData = function () {
        ...
        $.ajax($.extend({
            ...
            success: function (resp) {
                return 200 != eval('resp.' + _config.response.code) ? layer.msg(eval('resp.' + _config.response.data)) : _config.data = eval('resp.' + _config.response.data), _self.renderData(_config.data)
            },
            error: function () {
                hint.error("请求失败")
            }
